...
async function printBuildResults(buildInfo) {
  if (buildInfo.length === 1) {
    ...
    buildInfo.filter(i => (i === null || i === void 0 ? void 0 : i.status) === 'finished').forEach(build => {
      var _build$artifacts$buil, _build$artifacts2;

      (0, _log().default)(`Platform: ${build === null || build === void 0 ? void 0 : build.platform}, Artifact url: ${(_build$artifacts$buil = build === null || build === void 0 ? void 0 : (_build$artifacts2 = build.artifacts) === null || _build$artifacts2 === void 0 ? void 0 : _build$artifacts2.buildUrl) !== null && _build$artifacts$buil !== void 0 ? _build$artifacts$buil : ''}`);
    });
  }
}
