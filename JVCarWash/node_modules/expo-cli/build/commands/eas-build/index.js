...
function _default(program) {
  ...
  program.command('eas:build:init [path]').description('Initialize build configuration for the project').helpGroup('eas').option('--skip-credentials-check', 'Skip checking credentials', false).asyncActionProjectDir(_action3().default, {
    checkConfig: true
  });
