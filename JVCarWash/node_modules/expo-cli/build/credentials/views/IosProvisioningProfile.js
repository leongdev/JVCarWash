...
function _provisioningProfile() {
  const data = _interopRequireDefault(require("../utils/provisioningProfile"));
  ...
  async provideOrGenerate(ctx) {
    if (!this.nonInteractive) {
      ...
      if (userProvided) {
        ...
        return { ...userProvided,
          ..._provisioningProfile().default.readAppleTeam(userProvided.provisioningProfile)
        };
      }
    }
...
async function getProvisioningProfileFromParams(provisioningProfilePath) {
  ...
  const team = _provisioningProfile().default.readAppleTeam(provisioningProfile);
