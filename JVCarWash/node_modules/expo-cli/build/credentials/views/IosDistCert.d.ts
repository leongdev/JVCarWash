...
export declare class CreateIosDist implements IView {
    ...
    constructor(accountName: string, nonInteractive?: boolean);
...
export declare class RemoveIosDist implements IView {
    ...
    private nonInteractive;
    constructor(accountName: string, shouldRevoke?: boolean, nonInteractive?: boolean);
    open(ctx: Context): Promise<IView | null>;
...
export declare class CreateOrReuseDistributionCert implements IView {
    private app;
    private nonInteractive;
    constructor(app: AppLookupParams, nonInteractive?: boolean);
