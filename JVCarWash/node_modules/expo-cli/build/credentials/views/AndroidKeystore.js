...
class DownloadKeystore {
  ...
  async open(ctx) {
    var _this$options$outputP, _this$options4, _this$options5, _this$options$display, _this$options6;
    ...
    const {
      ...
      when: () => {
        ...
        return ((_this$options = this.options) === null || _this$options === void 0 ? void 0 : _this$options.displayCredentials) === undefined && !((_this$options2 = this.options) === null || _this$options2 === void 0 ? void 0 : _this$options2.quiet);
      }
    });
    ...
    if (!keystore || !keystorePassword || !keyAlias || !keyPassword) {
      ...
      if (!((_this$options3 = this.options) === null || _this$options3 === void 0 ? void 0 : _this$options3.quiet)) {
        _log().default.warn('There is no valid Keystore defined for this app');
      }
    ...
    const keystorePath = (_this$options$outputP = (_this$options4 = this.options) === null || _this$options4 === void 0 ? void 0 : _this$options4.outputPath) !== null && _this$options$outputP !== void 0 ? _this$options$outputP : `${this.experienceName.replace('/', '__')}.bak.jks`;
    await maybeRenameExistingFile(ctx.projectDir, keystorePath);

    if (!((_this$options5 = this.options) === null || _this$options5 === void 0 ? void 0 : _this$options5.quiet)) {
    ...
    if ((_this$options$display = (_this$options6 = this.options) === null || _this$options6 === void 0 ? void 0 : _this$options6.displayCredentials) !== null && _this$options$display !== void 0 ? _this$options$display : confirm) {
