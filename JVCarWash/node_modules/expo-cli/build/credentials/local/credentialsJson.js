...
async function readAndroidAsync(projectDir) {
  ...
  return {
    keystore: {
      keystore: await _fsExtra().default.readFile(keystoreInfo.keystorePath, 'base64'),
...
async function readIosAsync(projectDir) {
  ...
  return {
    provisioningProfile: await _fsExtra().default.readFile(credentialsJson.ios.provisioningProfilePath, 'base64'),
    distributionCertificate: {
      certP12: await _fsExtra().default.readFile(credentialsJson.ios.distributionCertificate.path, 'base64'),
