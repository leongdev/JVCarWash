 ...
 * @param options
 */
export declare function selectAsync(questions: NamelessQuestion | NamelessQuestion[], options?: PromptOptions): Promise<string>;
/**
 ...
 * @param options
 */
export declare function confirmAsync(questions: NamelessQuestion | NamelessQuestion[], options?: PromptOptions): Promise<boolean>;
/**
 ...
 * @param options
 */
export declare function toggleConfirmAsync(questions: NamelessQuestion | NamelessQuestion[], options?: PromptOptions): Promise<boolean>;
