...
async function setFacebookConfig(config, manifestDocument) {
    ...
    let mainApplication = (_b = (_a = manifestDocument === null || manifestDocument === void 0 ? void 0 : manifestDocument.manifest) === null || _a === void 0 ? void 0 : _a.application) === null || _b === void 0 ? void 0 : _b.filter((e) => e['$']['android:name'] === '.MainApplication')[0];
    ...
    if (appId) {
        ...
        mainApplication = removeMetaDataItemFromMainApplication(mainApplication, 'com.facebook.sdk.ApplicationId', '@string/facebook_app_id' // The corresponding string is set in setFacebookAppIdString
        );
    }
    if (displayName) {
...
function removeMetaDataItemFromMainApplication(mainApplication, itemName, itemValue) {
    if ('meta-data' in mainApplication) {
        const index = mainApplication['meta-data'].findIndex((e) => {
