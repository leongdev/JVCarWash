...
export declare type PublicConfig = ExpoConfig & {
    sdkVersion: string;
};
...
export declare function exportAssetsAsync({ projectRoot, exp, hostedUrl, assetPath, outputDir, bundles, }: ExportAssetsOptions): Promise<{
    exp: PublicConfig;
    assets: Asset[];
}>;
export {};
