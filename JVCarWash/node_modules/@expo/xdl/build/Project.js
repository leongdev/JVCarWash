...
async function exportForAppHosting(projectRoot, publicUrl, assetUrl, outputDir, options = {}) {
  var _options$publishOptio, _options$publishOptio2, _hooks$postExport;
  ...
  let androidSourceMap = null; // Build sourcemaps when `postExport` hook is set up or when `dumpSourcemap` argument is passed

  if (options.dumpSourcemap || (hooks === null || hooks === void 0 ? void 0 : hooks.postExport) && ((_hooks$postExport = hooks.postExport) === null || _hooks$postExport === void 0 ? void 0 : _hooks$postExport.length) > 0) {
    ({
      iosSourceMap,
      androidSourceMap
